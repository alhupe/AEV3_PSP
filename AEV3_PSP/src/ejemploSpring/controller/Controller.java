...
public class Controller {
	...
	/**
	 * Obtiene reseñas de una película específica.
	 *
	...
	/**
	 * Construye un objeto JSON con reseñas de una película.
	 *
	 * @param id        El ID de la película.
	 * @param titulo    El título de la película.
	 * @param ressenyes Lista de reseñas de la película.
	 * @return Objeto JSON con la información de la película y sus reseñas.
	 */
	...
	/**
	 * Maneja la solicitud para agregar una nueva reseña de película.
	 *
	...
	public ResponseEntity<String> novaPelicula(@RequestBody Map<String, String> requestBody) {
		...
		if (usuariAutoritzat(nomUsuari)) {
			...
			// Actualizar la lista llistaFitxers después de agregar la nueva película
	...
	public ResponseEntity<String> nouUsuari(@RequestBody Map<String, String> requestBody) {
		...
		if (usuariRegistrat(nomUsuari)) {
			return new ResponseEntity<>(HttpStatus.CONFLICT); // Usuario ya registrado, código 409
		}
	 ...
	 * registrados en las reseñas de películas.
	 *
	 * @param nomUsuari Nombre de usuario a verificar.
	...
	/**
	 * Obtiene la lista de usuarios registrados a través de las reseñas de todas las
	 * películas.
	 *
	...
	private static class Pelicula {
		...
		private final List<String> resenhas;
		 ...
		 * @param resenhas Lista de reseñas de la película.
		 */
		...
		/**
		 * Obtiene la lista de reseñas de la película.
		 *
		 * @return Lista de reseñas de la película.
		 */
